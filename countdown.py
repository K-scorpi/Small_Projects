...
try:
    while True:  # main cycle
        ...
        h_digits = base.getSevSegStr(minutes, 2)
        m_top_row, m_middle_row, m_bottom_row = h_digits.splitlines()

        h_digits = base.getSevSegStr(seconds, 2)
        s_top_row, s_middle_row, s_bottom_row = h_digits.splitlines()
